...
\textbf{Cronograma.} \begin{itemize}
      ...
      semanas}.
      \item \textbf{Setembro-Outubro}: Uso continuado do aplicativo pelos participantes mesmo após o fim das remunerações.
    \end{itemize}
...
viagens}, conforme evidenciado na Figura~\ref{fig:30mil-viagens}. Esse 
comportamento demonstra que o aplicativo gerou valor além do incentivo 
financeiro, sugerindo engajamento genuíno com a plataforma e potencial 
de retenção de usuários mesmo na ausência de recompensas monetárias.

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.95\textwidth]{figuras/30_mil_viagens.jpg}
  \caption{Captura de tela da lista de viagens no painel administrativo em 29/10/2025, 
  mostrando que o sistema havia ultrapassado 30 mil viagens registradas (ID da viagem 
  mais recente: 30073). Nota-se que todas as viagens exibidas têm remuneração zerada 
  (R\$~0,00), pois foram realizadas após o encerramento oficial do piloto em agosto, 
  evidenciando o uso continuado do aplicativo pelos participantes mesmo sem incentivo 
  financeiro.}
  \label{fig:30mil-viagens}
\end{figure}
...
Um uso adicional do painel foi o suporte a pesquisas complementares ao piloto. 
Por exemplo, o painel foi utilizado para identificar e selecionar os participantes 
que percorriam mais quilômetros usando bicicleta, permitindo que pesquisadores convidassem esses 
ciclistas mais ativos para participar de estudos específicos de coleta de dados, 
como pesquisas sobre qualidade do ar, do solo e proximidade de veículos durante deslocamentos 
urbanos realizadas em parceria com uma startup brasileiro-alemã.
