...
\begin{itemize}
  ...
  \item \textbf{Rate limiting}: Inicialmente havia um limite de 50 atualizações por hora na correção de localizações, que foi atingido durante operações intensivas de correção. Esse problema foi resolvido durante o piloto, permitindo que administradores do painel tivessem um limite maior para viabilizar as operações necessárias.
