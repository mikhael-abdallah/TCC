...
do curso gratuito ``Pedale com Segurança'' (Figura~\ref{fig:curso-seguranca}) 
oferecido pelo Centro de Treinamento e Educação de Trânsito (CETET) da CET, que 
treinou centenas de participantes do piloto em técnicas de ciclismo seguro no 
trânsito urbano; (ii) incentivar o preenchimento dos questionários qualitativos 
aplicados em três momentos do piloto, garantindo maior taxa de resposta e riqueza 
de dados; (iii) permitir ajustes administrativos e correções pontuais de pagamento 
quando necessário; e (iv) viabilizar eventuais campanhas promocionais temporárias 
para estimular a participação em momentos estratégicos do experimento.

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.95\textwidth]{figuras/pedale_com_seguranca.jpg}
  \caption{Captura de tela da primeira aula do curso gratuito ``Pedale com Segurança: 
  Boas práticas no ciclismo urbano'', ministrado pelo Prof. Mateus Humberto. O curso, 
  disponível em \url{bit.ly/pedalarcomseguranca}, foi oferecido aos participantes do 
  piloto BikeSP como parte do programa de capacitação em segurança viária.}
  \label{fig:curso-seguranca}
\end{figure}
...
possui esse bônus; Usuário 203 não existe''). Essa funcionalidade de concessão em
...
concluíram em determinada semana. A Figura~\ref{fig:bonus_atribuir_form} ilustra essa interface.
...
apareçam para os usuários finais. Essa separação entre visibilidade e concessão
